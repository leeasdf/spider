<template>
  <el-dialog
    ...
    <el-form-item label="行政处罚决定书文号" prop="caseNo">
    ...
    <el-form-item label="法定代表人（或单位负责人）" prop="representative">
    ...
    <el-form-item label="作出行政处罚的日期" prop="punishmentDate">
      <el-input v-model="dataForm.punishmentDate" placeholder="作出行政处罚的日期"></el-input>
    </el-form-item>
    <el-form-item label="行政处罚决定书（全文或摘要）" prop="content">
      <el-input v-model="dataForm.content" placeholder="行政处罚决定书（全文或摘要）"></el-input>
    </el-form-item>
    <el-form-item label="发布日期" prop="issueDate">
      <el-input v-model="dataForm.issueDate" placeholder="发布日期"></el-input>
    </el-form-item>
