...
public class Open404EquityInfoDTO implements Serializable {
	...
	private Number putDate;// 股权出质设立发布日期 毫秒数
	private List<Open404EquityInfoCompanyListDTO> companyList;// 公司列表
	private String pledgorStr;// 跳转到天眼查链接
	private List<Open404EquityInfoPledgeeListDTO> pledgeeList;// 质权人列表
	private Number regDate;// 股权出质设立登记日期 毫秒数
	private List<Open404EquityInfoPledgorListDTO> pledgorList;// 出质人列表
	...
	public Number getPutDate() {
		return putDate;
	}

	public void setPutDate(Number putDate) {
		this.putDate = putDate;
	}

	public List<Open404EquityInfoCompanyListDTO> getCompanyList() {
		return companyList;
	}

	public void setCompanyList(List<Open404EquityInfoCompanyListDTO> companyList) {
	...
	public List<Open404EquityInfoPledgorListDTO> getPledgorList() {
		return pledgorList;
	}

	public void setPledgorList(List<Open404EquityInfoPledgorListDTO> pledgorList) {
