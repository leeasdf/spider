...
public class CloudStorageConfig implements Serializable {
    ...
    //天创文件服务绑定的域名
    @NotBlank(message="天创云绑定的域名不能为空", groups = TcreditGroup.class)
    @URL(message = "天创云的域名格式不正确", groups = TcreditGroup.class)
    private String tcreditDomain;
    //腾讯云SecretKey
    @NotBlank(message="天创云tcreditKey不能为空", groups = TcreditGroup.class)
    private String tcreditKey;
    //腾讯云SecretKey
    @NotBlank(message="天创云tcreditSecret不能为空", groups = TcreditGroup.class)
    private String tcreditSecret;
    ...
    public String getTcreditDomain() {
        return tcreditDomain;
    }

    public void setTcreditDomain(String tcreditDomain) {
        this.tcreditDomain = tcreditDomain;
    }

    public String getTcreditKey() {
        return tcreditKey;
    }

    public void setTcreditKey(String tcreditKey) {
        this.tcreditKey = tcreditKey;
    }

    public String getTcreditSecret() {
        return tcreditSecret;
    }

    public void setTcreditSecret(String tcreditSecret) {
        this.tcreditSecret = tcreditSecret;
    }
}
