 ...
 * 
 */
public class LitigationDetailRespDTO {
	...
	private LitigationDetailDataDTO data;
	...
	public LitigationDetailDataDTO getData() {
		return data;
	}

	public void setData(LitigationDetailDataDTO data) {
		this.data = data;
	}
