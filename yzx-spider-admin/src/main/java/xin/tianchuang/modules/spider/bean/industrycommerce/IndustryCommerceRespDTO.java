...
public class IndustryCommerceRespDTO {
	...
	private IndustryCommerceDataDTO data;
	...
	public IndustryCommerceDataDTO getData() {
		return data;
	}

	public void setData(IndustryCommerceDataDTO data) {
		this.data = data;
	}
