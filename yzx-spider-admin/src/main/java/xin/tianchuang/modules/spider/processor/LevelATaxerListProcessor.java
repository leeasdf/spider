 ...
 */
@Component
public class LevelATaxerListProcessor implements PageProcessor {
    public static final String FIRST_PAGE_URL = "http://www.credithunan.gov.cn/page/info/sincerityList.jsp?id=70FC85017BB464A4EE20219D484A0716";
    //找到发布时间，最多尝试翻多少页,理论上如果每天都爬的话，应该翻不了多少页
    public static final int OVER_PAGE_NUM = 100 * 1000;
    //行政处罚分页json数据请求地址
    public static final String LIST_URL = "http://www.credithunan.gov.cn/page/info/promptsProxy.jsp?id=70FC85017BB464A4EE20219D484A0716&perpage=20&totalRecord=20949";
    public static final String SEARCH_URL = "http://www.credithunan.gov.cn/page/searchList.jsp";
    //单页条数,依赖网站所能提供的每页数据量，不能随便改
    public static final int NUM_PER_PAGE = 10;

    @Resource
    private LevelATaxerContentProcessor levelATaxerContentProcessor;
    ...
    public void spiderRun(String dataListStr){
        if (StringUtils.isNotBlank(dataListStr)) {
            Spider contentSpider = Spider.create(levelATaxerContentProcessor).thread(1);
            ...
            for (String dataStr : dataArr) {
                ...
                Request request = new Request(LevelATaxerContentProcessor.CONTENT_URL + fields[1])
                        .setExtras(extras)
                        .setMethod("post");
