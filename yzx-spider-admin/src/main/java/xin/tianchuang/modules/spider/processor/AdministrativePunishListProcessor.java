...
public class AdministrativePunishListProcessor implements PageProcessor{
    @Resource
    private AdministrativePunishContentProcessor administrativePunishContentProcessor;
    ...
    public static final String SEARCH_URL = "http://www.credithunan.gov.cn:30816/publicity_hn/webInfo/punishmentList.do";
    ...
    public void process(Page page) {
        ...
        if (StringUtils.isNotBlank(dataListStr)) {
            Spider contentSpider = Spider.create(administrativePunishContentProcessor).thread(1);
