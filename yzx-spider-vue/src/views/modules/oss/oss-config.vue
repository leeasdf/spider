    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="100px">
      ...
      <template v-if="dataForm.type === 4">
        <el-form-item label="上传接口">
          <el-input v-model="dataForm.tcreditDomain" placeholder="天创云上传接口"></el-input>
        </el-form-item>
        <el-form-item label="上传key">
          <el-input v-model="dataForm.tcreditKey" placeholder="天创云上传key"></el-input>
        </el-form-item>
        <el-form-item label="上传token">
          <el-input v-model="dataForm.tcreditSecret" placeholder="天创云上传token"></el-input>
        </el-form-item>
      </template>
    </el-form>
