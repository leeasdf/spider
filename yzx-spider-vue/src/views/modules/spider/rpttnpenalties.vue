  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('spider:rpttnpenalties:save')" type="primary" @click="addOrUpdateHandle()">新增</el-button>
        <el-button v-if="isAuth('spider:rpttnpenalties:delete')" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">批量删除</el-button>
      </el-form-item>
    </el-form>
    <el-table
      :data="dataList"
      ...
      <el-table-column type="expand" width="40">
        <template slot-scope="props">
          <el-form inline class="yzx-table-expand">
            ...
            <el-form-item label="处罚内容" class="yzx-table-rowspan"><span>{{props.row.content}}</span></el-form-item>
            <el-form-item label="决定书文号"><span>{{props.row.punishNumber}}</span></el-form-item>
...
<script>
  import AddOrUpdate from './rpttnpenalties-add-or-update'
    ...
    methods: {
      ...
      deleteHandle (id) {
        ...
        this.$confirm(`确定对[id=${ids.join(',')}]进行[${id ? '删除' : '批量删除'}]操作?`, '提示', {
          ...
          this.$http({
            url: this.$http.adornUrl('/spider/rpttnpenalties/delete'),
            method: 'post',
